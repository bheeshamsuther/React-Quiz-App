        ...
        return (
            <div>
                ...
                {getRes ? 
                        ...
                        <div className="descrp" style={{padding:10,width:"100%",borderRadius:5}}>
                            <h2 style={{textAlign:"center",padding:"20px 10px",borderRadius:5,width:500}}>Result</h2>
                            {resfail ?
                ...
                <div className="disc" style={{minHeight: "0px",height: "auto",transitionDuration: "214ms"}}>
                <div style={{display:"flex"}}>
                <div className="descrp1" style={{width:"100%",}}>
                    <h2 style={{textAlign:"center",padding:"10px 5px",borderRadius:5}}>Description</h2>
